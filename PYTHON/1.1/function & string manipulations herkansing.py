    ...
    while True:
        try:
            if selection == "1":
                ...
                print(f"The text has been translated to: {shift_word_position(1,text_to_translate)}")
                print(f"The text has been translated to: {shift_word_position(3,text_to_translate)}")
                print_menu()
            else:
...
def shift_word_position(num,text_to_translate):
    #shift the last one letter to the beginning of the sentence
    original_word = text_to_translate.split()
    shifted_list_one_letter = original_word[-num:] + original_word[:-num]
